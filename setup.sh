...
clear
#echo -e "${red}♦️${NC} ${green}Established By RyukillerZ 2022${NC} ${red}♦️${NC}"
...
#wget -q -O /usr/share/nginx/html/index.html "https://raw.githubusercontent.com/RyukillerZ/XRAY/main/OTHERS/index.html"
...
echo -e "${RB}      '-------------------------------------------'${NC}"
echo -e "${BB}————————————————————————————————————————————————————————${NC}"
echo -e "      ${WB}Multiport Websocket Autoscript By RyukillerZ${NC}"
echo -e "${BB}————————————————————————————————————————————————————————${NC}"
