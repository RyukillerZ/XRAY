...
wget -O /usr/local/bin/xray "https://raw.githubusercontent.com/RyukillerZ/XRAY/main/xray.linux.64bit"
chmod +x /usr/local/bin/xray
...
Documentation=https://RyukillerZ-Project.net https://github.com/XTLS/Xray-core
